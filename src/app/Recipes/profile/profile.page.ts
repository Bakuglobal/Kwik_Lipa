...
export class ProfilePage implements OnInit {
  ...
  getMeals(){
    this.service.getMeals(this.data.shop).subscribe(res => {
  ...
  getCategories(){
    this.service.getCategory(this.data.shop).subscribe(res => {
  ...
  seeDetails(item){
    ...
    this.service.hiddenTabs = true ;
    this.navCtrl.navigate(['tabs/recipeDetails'], navigationExtras);
  }
}
