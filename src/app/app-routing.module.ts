...
const routes: Routes = [
  ...
  { path: 'selectshop', loadChildren: './selectshop/selectshop.module#SelectshopPageModule' },
  { path: 'image-display', loadChildren: './image-display/image-display.module#ImageDisplayPageModule' },
  { path: 'discountproducts', loadChildren: './discount/discountproducts/discountproducts.module#DiscountproductsPageModule' },
  { path: 'discountmodal', loadChildren: './discountmodal/discountmodal.module#DiscountmodalPageModule' },
  { path: 'featuredproducts', loadChildren: './featuredproducts/featuredproducts.module#FeaturedproductsPageModule' },
  { path: 'featuredmodal', loadChildren: './featuredmodal/featuredmodal.module#FeaturedmodalPageModule' },
  // { path: 'create-list', loadChildren: './create-list/create-list.module#CreateListPageModule' },
  // { path: 'view-order', loadChildren: './view-order/view-order.module#ViewOrderPageModule' },
